...
void savetostl(double XX[p], double YY[p], int T[N][3],  int p, int N)
{
    ...
    for(k=0;k<N;k++)
    {
        ...
        TRstl <<"outer loop\n";
        TRstl <<"vertex ";
        TRstl << XX[ia]*(-1) <<" "<< YY[ia] <<" "<< 0.0 <<"\n";
        TRstl << "vertex ";
        TRstl << XX[ib]*(-1) <<" "<< YY[ib] <<" "<< 0.0 <<"\n";
        TRstl << "vertex ";
        TRstl << XX[ic]*(-1) <<" "<< YY[ic] <<" "<< 0.0 <<"\n";
        TRstl << "endloop\n";
        TRstl << "endfacet\n";
        ...
        TRstl <<"outer loop\n";
        TRstl <<"vertex ";
        TRstl << XX[ia]*(-1) <<" "<< YY[ia]*(-1) <<" "<< 0.0 <<"\n";
        TRstl << "vertex ";
        TRstl << XX[ib]*(-1) <<" "<< YY[ib]*(-1) <<" "<< 0.0 <<"\n";
        TRstl << "vertex ";
        TRstl << XX[ic]*(-1) <<" "<< YY[ic]*(-1) <<" "<< 0.0 <<"\n";
        TRstl << "endloop\n";
        TRstl << "endfacet\n";
        ...
        TRstl <<"outer loop\n";
        TRstl <<"vertex ";
        TRstl << XX[ia] <<" "<< YY[ia]*(-1) <<" "<< 0.0 <<"\n";
        TRstl << "vertex ";
        TRstl << XX[ib] <<" "<< YY[ib]*(-1) <<" "<< 0.0 <<"\n";
        TRstl << "vertex ";
        TRstl << XX[ic] <<" "<< YY[ic]*(-1) <<" "<< 0.0 <<"\n";
        TRstl << "endloop\n";
        TRstl << "endfacet\n";
    }
    TRstl <<"endsolid";
...
int main()
{
    double tethai,tauj,g,alpha=0,betha=PI/2;
    int k = 0;
